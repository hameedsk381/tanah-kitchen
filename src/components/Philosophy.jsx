      ...
      <div className="max-w-container px-8 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="absolute -top-6 -left-6 w-full h-full border border-gold/10 -z-10 pointer-events-none" />
          </motion.div>
          ...
          >
            ...
            <h2 className="font-display font-light text-text-light leading-tight" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)' }}>
              {philosophy.title}<br />
              <span className="italic text-gold">{philosophy.titleItalic}</span>
            </h2>
