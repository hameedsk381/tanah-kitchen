  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0 opacity-10 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80rem] h-[80rem] rounded-full border border-gold" />
      </div>
      ...
      <div className="max-w-[1000px] px-8 mx-auto relative z-10 text-center">
        ...
        >
          ...
          <h2 className="font-display font-light text-text-light leading-tight" style={{ fontSize: 'clamp(2.5rem, 5vw, 4.5rem)' }}>
            Experience <span className="italic text-gold">Tanah Kitchen & Bar</span>
          </h2>
          
          <p className="text-sm font-light text-text-muted max-w-xl mx-auto leading-relaxed">
