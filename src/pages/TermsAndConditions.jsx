          ...
          <div className="wp-card p-8 sm:p-12 md:p-16 space-y-10 text-left shadow-xl border border-[#6B2523]/10">
            ...
            <div className="space-y-4 pt-4 border-t border-[#6B2523]/10">
              ...
              <ul className="space-y-2.5 text-sm sm:text-base text-[#3A2E2A]/80 font-body list-disc pl-6">
                <li><strong className="text-[#6B2523]">15-Minute Grace Period:</strong> Reserved tables will be held for a maximum of 15 minutes past the confirmed reservation time. If your party is delayed, please inform our reception desk to avoid table reallocation.</li>
                <li><strong className="text-[#6B2523]">Seating Allocation:</strong> While we endeavor to fulfill specific area requests (such as the open-air Sunset Terrace or intimate Basalt booths), table allocations are subject to real-time weather and operational availability.</li>
                <li><strong className="text-[#6B2523]">Large Corporate Groups:</strong> Bookings for parties of 15 or more guests may require an advance culinary selection and a customized reservation agreement.</li>
              </ul>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t border-[#6B2523]/10">
              ...
              <p className="text-sm sm:text-base font-light text-[#3A2E2A]/85 leading-relaxed font-body">
                To preserve the serene, elevated ambiance of our rooftop sanctuary, we encourage <strong className="text-[#6B2523]">Resort Casual / Smart Casual</strong> attire. Athletic sportswear, beachwear, and flip-flops are respectfully discouraged in the evening dining rooms.
              </p>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t border-[#6B2523]/10">
              ...
              <ul className="space-y-2.5 text-sm sm:text-base text-[#3A2E2A]/80 font-body list-disc pl-6">
                <li>In accordance with Telangana Excise laws, alcoholic beverages are served strictly to guests aged <strong className="text-[#6B2523]">21 years and older</strong>. Valid government-issued photo identification may be requested.</li>
